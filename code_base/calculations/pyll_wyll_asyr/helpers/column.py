class COLUMN_HEAD:
    ...
    WYLL_MEAN_DECORATED = WYLL_MEAN + ' ±'
    WYLL_AVG_MEAN = 'WYLL_average_mean'
    WYLL_AVG_FLUC = 'WYLL_fluctuation'
    WYLL_AVG_MEAN_DECORATED = WYLL_AVG_MEAN + ' ±'
    ...
    MEAN_AGE_PER_GROUP = 'Mean_Age_Per_Group'
    WORKING_YEARS_LEFT_MEAN = 'Working_Years_Left_Mean'